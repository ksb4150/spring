...
//			  					 @RequestParam("userName") String userName, HttpServletRequest request, HttpServletResponse response) throws Exception {
//	  
...
//		  System.out.println("userID : "+userID);
//		  System.out.println("userName : "+userName);
//		  System.out.println("email : "+email); mav.addObject("userID", userID);
//		  
//		  	mav.addObject("userName", userName);
//	  
//		  return mav; 
...
//	public ModelAndView login4(@ModelAttribute("info") LoginVO linginVO,
